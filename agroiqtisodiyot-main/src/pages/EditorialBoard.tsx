  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-300">
      ...
      <section className="relative h-[250px] md:h-[320px] flex items-center justify-center overflow-hidden bg-mesh-dark">
        <div className="absolute top-10 left-20 w-32 h-32 border border-white/5 rounded-full animate-spin-slow -z-10" />
        <div className="absolute bottom-10 right-20 w-44 h-44 rounded-full bg-emerald-500/5 blur-2xl animate-float-slow -z-10" />

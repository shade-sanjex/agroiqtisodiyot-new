  ...
  return (
    <PageShell>
      <PageHero
        ...
        description="Loyiha haqida savollaringiz, takliflaringiz yoki ilmiy hamkorlik g'oyalaringiz bo'lsa, quyidagi vositalar orqali murojaat qiling."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-start">
              ...
              <div className="space-y-4">
                {contactInfo.map((item, i) => (
                  <ScrollReveal key={i} delay={i * 0.05}>
                    <GlassCard
                      interactive
                      className="group p-5 flex items-start gap-5 relative overflow-hidden"
                    >
                      ...
                      <div>
                        <p className="font-semibold text-xs text-muted-foreground uppercase tracking-widest mb-1">{item.label}</p>
                        {item.href ? (
                ...
                <ScrollReveal delay={0.2}>
                  <GlassCard variant="subtle" className="mt-8 p-6 flex items-center gap-5">
            ...
            <div className="lg:col-span-7">
              <ScrollReveal direction="right">
                <GlassCard variant="elevated" className="p-6 md:p-10 text-left">
                  <h2 className="text-2xl font-serif font-black text-foreground mb-8">
                    Xabar Yuborish
                  </h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Ismingiz</label>
                        <Input
                          required
                          value={formData.name}
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Xabar Matni</label>
                      <Textarea
                        required
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1 text-right font-mono">{formData.message.length}/2000</p>
                    </div>

                    <Button type="submit" variant="primary" className="w-full rounded-full h-12 font-bold uppercase tracking-wider text-xs" disabled={loading}>
                      {loading ? (
